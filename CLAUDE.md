...
- `index.html` and `agents/*.html` are generated by `npm run catalog` from `_build/content/*.json`,
  `_build/site.json` and `_build/categories.json`. Never hand-edit the generated HTML; edit the JSON
  and rebuild. `process.html` is hand-written on `assets/site.css`.
