...
export const cleanEssentials: EssentialsRaw = {
  ...
  forms: [{ action: '/subscribe', method: 'post', fields: 2, required: 2, emailTyped: 1, labelled: 2, novalidate: false, consentCheckbox: true, captcha: true, honeypot: false, inlineSubmitHandler: false, passwordField: false }],
